...
namespace MyQuickDesk.Migrations
{
    ...
    [Migration("20230610155852_AddParkingSpot")]
            ...
            modelBuilder.Entity("MyQuickDesk.Entities.Desk", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("df9af4d7-31be-495e-b0b2-9761c8612dd9"),
                            IsAvaible = true,
                            MaxCapacity = 1,
                            Name = "Biurko A1"
                        },
                        new
                        {
                            Id = new Guid("8a977b4a-6945-40a2-968f-23cde452aa76"),
                            IsAvaible = true,
                            MaxCapacity = 1,
                            Name = "Biurko A2"
                        },
                        new
                        {
                            Id = new Guid("94772cfd-de17-4e5f-9ece-0f2752eb55bb"),
                            IsAvaible = true,
                            MaxCapacity = 1,
                            Name = "Biurko A3"
                        },
                        new
                        {
                            Id = new Guid("30e202c2-0a29-48a6-ab27-f5b2b006db79"),
                            IsAvaible = true,
                            MaxCapacity = 1,
                            Name = "Biurko B1"
                        },
                        new
                        {
                            Id = new Guid("d2338cf4-d76d-4147-ae53-af9b8e66ebbf"),
                            IsAvaible = true,
                            MaxCapacity = 1,
                            Name = "Biurko B2"
                        });
            ...
            modelBuilder.Entity("MyQuickDesk.Entities.ParkingSpot", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("1181c881-dc78-4d37-9f67-e6e87c94ccc6"),
                            IsAvaible = true,
                            MaxCapacity = 1,
                            Name = "P1A1",
                            Charger = true,
                        ...
                        new
                        {
                            Id = new Guid("a1179c99-57af-42b2-a568-df4434a84e18"),
                            IsAvaible = true,
                            MaxCapacity = 1,
                            Name = "P1A2",
                            Charger = true,
                        ...
                        new
                        {
                            Id = new Guid("8db753a8-5975-4a28-a09e-43e0d14e8639"),
                            IsAvaible = true,
                            MaxCapacity = 1,
                            Name = "P1A3",
                            Charger = true,
                        ...
                        new
                        {
                            Id = new Guid("97ac94bc-81d2-4f48-9e0f-ff806e975e6a"),
                            IsAvaible = true,
                            MaxCapacity = 1,
                            Name = "P1B1",
                            Charger = true,
            ...
            modelBuilder.Entity("MyQuickDesk.Entities.Room", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("5a6b2856-078e-4977-b31c-2035c5be1c13"),
                            IsAvaible = true,
                            MaxCapacity = 8,
                            Name = "Mariacka"
                        },
                        new
                        {
                            Id = new Guid("08fa6d82-7705-4a36-a8a2-d93b2c72b5b0"),
                            IsAvaible = true,
                            MaxCapacity = 10,
                            Name = "Neptun"
                        },
                        new
                        {
                            Id = new Guid("71286cce-3a8a-4761-8f99-3241994c52e5"),
                            IsAvaible = true,
                            MaxCapacity = 12,
                            Name = "Polityczna"
                        });
