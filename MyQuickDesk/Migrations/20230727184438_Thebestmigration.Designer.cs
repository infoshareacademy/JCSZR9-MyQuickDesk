...
namespace MyQuickDesk.Migrations
{
    ...
    [Migration("20230727184438_Thebestmigration")]
            ...
            modelBuilder.Entity("MyQuickDesk.Entities.Desk", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("a7b985bd-ce6c-4afd-be80-1d06b09ff045"),
                            IsAvaiable = true,
                            MaxCapacity = 1,
                            Name = "Biurko A1"
                        },
                        new
                        {
                            Id = new Guid("10065deb-8b2a-4d37-8e80-068acdc717dd"),
                            IsAvaiable = true,
                            MaxCapacity = 1,
                            Name = "Biurko A2"
                        },
                        new
                        {
                            Id = new Guid("224183c1-51f4-48ed-a9ae-fbd2aea8e1af"),
                            IsAvaiable = true,
                            MaxCapacity = 1,
                            Name = "Biurko A3"
                        },
                        new
                        {
                            Id = new Guid("2414bcfe-0b2e-4682-ac7a-ef99801fef70"),
                            IsAvaiable = true,
                            MaxCapacity = 1,
                            Name = "Biurko B1"
                        },
                        new
                        {
                            Id = new Guid("ab9da83e-e29f-4f77-a533-da0a8dd4fa08"),
                            IsAvaiable = true,
                            MaxCapacity = 1,
                            Name = "Biurko B2"
                        });
            ...
            modelBuilder.Entity("MyQuickDesk.Entities.ParkingSpot", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("c87d3ca0-f84a-47c9-bb92-1bbb68519135"),
                            IsAvaiable = true,
                            MaxCapacity = 1,
                            Name = "P1A1",
                            Charger = true,
                        ...
                        new
                        {
                            Id = new Guid("d952b8f3-2f8b-44b6-8c68-8b2c0d727eb7"),
                            IsAvaiable = true,
                            MaxCapacity = 1,
                            Name = "P1A2",
                            Charger = true,
                        ...
                        new
                        {
                            Id = new Guid("d705b125-a265-45c7-93c5-13f6cf374d39"),
                            IsAvaiable = true,
                            MaxCapacity = 1,
                            Name = "P1A3",
                            Charger = true,
                        ...
                        new
                        {
                            Id = new Guid("f3331277-acaf-4f7d-ad55-c313ffd79e0d"),
                            IsAvaiable = true,
                            MaxCapacity = 1,
                            Name = "P1B1",
                            Charger = true,
            ...
            modelBuilder.Entity("MyQuickDesk.Entities.Room", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("6e83f6f5-f334-43f9-a17d-197f9bae429d"),
                            IsAvaiable = true,
                            MaxCapacity = 8,
                            Name = "Mariacka"
                        },
                        new
                        {
                            Id = new Guid("6452b44e-ca8b-48cd-801e-3c6a57848479"),
                            IsAvaiable = true,
                            MaxCapacity = 10,
                            Name = "Neptun"
                        },
                        new
                        {
                            Id = new Guid("b96470c9-7558-4199-b691-13cd1352edff"),
                            IsAvaiable = true,
                            MaxCapacity = 12,
                            Name = "Polityczna"
                        });
