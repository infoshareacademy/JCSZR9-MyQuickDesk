            ...
            modelBuilder.Entity("MyQuickDesk.Entities.Desk", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("05f9f9b4-af86-44a6-b3f1-6523d6372291"),
                            IsAvaiable = true,
                            MaxCapacity = 1,
                            Name = "Biurko A1"
                        },
                        new
                        {
                            Id = new Guid("7f698cf0-e92d-444d-b184-4290ff17266f"),
                            IsAvaiable = true,
                            MaxCapacity = 1,
                            Name = "Biurko A2"
                        },
                        new
                        {
                            Id = new Guid("3d84fc43-91aa-4e2d-90d6-25a6d5aacb5a"),
                            IsAvaiable = true,
                            MaxCapacity = 1,
                            Name = "Biurko A3"
                        },
                        new
                        {
                            Id = new Guid("debd8e78-70f8-44e4-8387-58f9ba0f879d"),
                            IsAvaiable = true,
                            MaxCapacity = 1,
                            Name = "Biurko B1"
                        },
                        new
                        {
                            Id = new Guid("1c926b8c-acd3-4d8e-b6e7-c9e0902aee1e"),
                            IsAvaiable = true,
                            MaxCapacity = 1,
                            Name = "Biurko B2"
                        });
            ...
            modelBuilder.Entity("MyQuickDesk.Entities.ParkingSpot", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("48dfbc8e-a779-4588-a48a-bc2d5a9e5420"),
                            IsAvaiable = true,
                            MaxCapacity = 1,
                            Name = "P1A1",
                            Charger = true,
                        ...
                        new
                        {
                            Id = new Guid("763cc096-6762-4ff8-a0a8-9cb7464a723e"),
                            IsAvaiable = true,
                            MaxCapacity = 1,
                            Name = "P1A2",
                            Charger = true,
                        ...
                        new
                        {
                            Id = new Guid("6f85a73a-d56a-476a-bac0-8445d56d0f37"),
                            IsAvaiable = true,
                            MaxCapacity = 1,
                            Name = "P1A3",
                            Charger = true,
                        ...
                        new
                        {
                            Id = new Guid("8f067289-45b3-4923-a082-6e9ff4b47d3e"),
                            IsAvaiable = true,
                            MaxCapacity = 1,
                            Name = "P1B1",
                            Charger = true,
            ...
            modelBuilder.Entity("MyQuickDesk.Entities.Room", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("04fecc9b-3f79-4529-843c-847b84c276be"),
                            IsAvaiable = true,
                            MaxCapacity = 8,
                            Name = "Mariacka"
                        },
                        new
                        {
                            Id = new Guid("711381aa-85ae-4c38-ba06-7268c77a15dc"),
                            IsAvaiable = true,
                            MaxCapacity = 10,
                            Name = "Neptun"
                        },
                        new
                        {
                            Id = new Guid("f3b3e9d0-8426-4bec-b8e8-f69d4f554ba5"),
                            IsAvaiable = true,
                            MaxCapacity = 12,
                            Name = "Polityczna"
                        });
